...
const footer = {
    "aboutUs": `با افتخار، قطعه یار به عنوان یکی از معتبرترین تامین‌کنندگان انواع قطعات لوازم خانگی شناخته خواهد شد. ما با تیمی باتجربه و متخصص با بیش از 10 سال سابقه در این حوزه، به شما این اطمینان را می‌دهیم که قطعات مورد نیاز خود را با کیفیت بالا و بهترین قیمت تهیه کنید. \n ما به شما این امکان را می‌دهیم که بدون نگرانی از کیفیت قطعات، بر روی کارهای دیگر خود تمرکز کنید. ما در قطعه یار به کیفیت محصولات و رضایت مشتریان خود اهمیت ویژه‌ای می‌دهیم و همواره در تلاش هستیم تا بهترین خدمات را به شما ارائه دهیم. \n با قطعه یار دیگر نگران تهیه قطعات با کیفیت نباشید؛ ما تامین‌کننده‌ی مطمئن شما هستیم.`,
    "address": "تهران، خیابان جمهوری، پاساژ آلومینیوم، طبقه 4، واحد 34",
